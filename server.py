...
print(f"  {clr.CYAN} PORT:{clr.RESET} {clr.YELLOW}{args.port}{clr.RESET}\n  {clr.CYAN} IP:{clr.RESET} {clr.YELLOW}{args.ip}{clr.RESET}\n  {clr.CYAN} MAX CONNECTIONS:{clr.RESET} {clr.YELLOW}{args.max_connections}{clr.RESET}")
